...
export default function PrivacyPolicyPage() {
  ...
  useEffect(() => {
    async function fetchPolicy() {
      try {
        const snap = await getDoc(doc(db, 'settings', 'privacyPolicy'));
        if (snap.exists()) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f8fafc] flex flex-col font-sans text-slate-800 antialiased selection:bg-emerald-200 selection:text-emerald-950">
        ...
        <div className="relative pt-24 pb-36 lg:pt-32 lg:pb-48 overflow-hidden bg-slate-950">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight mb-6 leading-tight">
              We Value Your <br className="hidden sm:block" />
            ...
            <div className="px-6 sm:px-12 lg:px-16 py-10 sm:py-16 min-h-[400px]">
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 gap-4 text-center bg-red-50 rounded-3xl border border-red-100">
                  ...
                  <p className="text-sm font-medium text-red-500 max-w-xs">There was an error fetching the privacy policy. Please try again later.</p>
                </div>
              ) : !content ? (
                <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
                  ...
                  <p className="text-sm text-slate-500">The privacy policy document has not been published yet.</p>
                </div>
              ) : (
                <div
                  className="privacy-policy-render"
      ...
      <style>{`
        ...
        .privacy-policy-render h1, 
        .privacy-policy-render h2, 
        .privacy-policy-render h3 {
          color: #0f172a;
          font-family: inherit;
        }
        ...
        .privacy-policy-render h2::after {
          content: '';
          position: absolute;
          left: 0;
          bottom: -2px;
        ...
        .privacy-policy-render h3::before {
          content: '';
        ...
        .privacy-policy-render p {
          margin-bottom: 1.25rem;
          color: #475569;
        }

        .privacy-policy-render ul, 
        .privacy-policy-render ol {
          margin-top: 1rem;
        ...
        /* Custom list bullets */
        .privacy-policy-render ul li::before {
          content: '';
          position: absolute;
          left: 0.25rem;
          top: 0.65rem;
        ...
        .privacy-policy-render ol li {
          padding-left: 2.25rem;
        }
        .privacy-policy-render ol li::before {
        ...
        .privacy-policy-render blockquote {
          position: relative;
          margin: 2rem 0;
        ...
        .privacy-policy-render blockquote::before {
          content: '"';
          position: absolute;
          left: 1rem;
          top: -0.5rem;
        ...
        .privacy-policy-render a:hover {
          color: #047857;
        }
        
        .privacy-policy-render a:hover::after {
          transform: scaleX(1);
          transform-origin: bottom left;
        }

        .privacy-policy-render hr {
          border: none;
          height: 1px;
        ...
        .privacy-policy-render > :first-child {
          margin-top: 0;
        }
        
        /* Last element no bottom margin */
        .privacy-policy-render > :last-child {
          margin-bottom: 0;
        }
      `}</style>
    </div>
